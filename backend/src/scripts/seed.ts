...
await query(`INSERT INTO transactions (id, payer_id, payee_id, property_id, unit_id, lease_id, type, amount, currency, status, gateway, gateway_transaction_id, metadata)
  VALUES ($1, $2, $3, $4, $5, $6, 'refund', 750.00, 'USD', 'refunded', 'stripe', 'ch_james_refund_001',
  ...
  [txnId7, landlordId, vendorId, propId, unitId1, null]);
    ...
    await query(`
      ...
      VALUES
         ...
         ($7,  $2, 'landlord', 2000.00, 100.00, 'pending', CURRENT_DATE + INTERVAL '3 days', $8),
         ...
         ($14, $2, 'landlord',  850.00, 42.50, 'pending', CURRENT_DATE + INTERVAL '5 days', $8),
         ...
         ($17, $5, 'vendor',     75.00, 3.75, 'pending', CURRENT_DATE + INTERVAL '3 days', $6)
    `,
    [
